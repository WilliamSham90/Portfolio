// ============================================================================
// projects.js — orchestrator for the Projects page.
//
// Same fetch-and-mount pattern as Pages/Home/home.js, trimmed to only the
// sections this page actually uses: Navbar, Projects, Footer. Nothing in
// Widgets/ was changed to make this page possible — it just assembles a
// smaller slice of the same reusable fragments.
// ============================================================================
